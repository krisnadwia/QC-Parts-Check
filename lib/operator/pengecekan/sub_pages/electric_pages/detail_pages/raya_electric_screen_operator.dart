...
class RayaElectricScreenOperator extends StatefulWidget {
  const RayaElectricScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _RayaElectricScreenOperatorState();
}

class _RayaElectricScreenOperatorState extends State<RayaElectricScreenOperator> {
  // Create a timestamp
  ...
  Future<void> _deleteData(String dataId) async {
    await _rayaElectricParts.doc(dataId).delete();
            ...
            builder: (context, snapshot) {
              ...
              return IconButton(
                ...
                onPressed: () {
                  ...
                  _keteranganNotifikasiController.text = "Data ditambahkan: Raya Electric Part";
                  _createOrUpdate();
                },
              );
            },
