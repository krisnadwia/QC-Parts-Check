...
class RayaPlasticScreenOperator extends StatefulWidget {
  const RayaPlasticScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _RayaPlasticScreenOperatorState();
}

class _RayaPlasticScreenOperatorState extends State<RayaPlasticScreenOperator> {
  var itemsNamaPart = [
    "Backshield",
    "Battery Partition",
    "Bottom Seat",
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getDataFromFirestore() {
    return FirebaseFirestore.instance.collection('raya_plastic_parts').orderBy("tanggalPengecekan", descending: true).snapshots();
  }
  ...
  Future<void> _deleteProduct(String productId) async {
    await _rayaPlasticParts.doc(productId).delete();
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final anchor = html.document.createElement("a") as html.AnchorElement..href = url..style.display = "none"..download = "Raya_Plastic_Parts_$formattedDate.csv";
