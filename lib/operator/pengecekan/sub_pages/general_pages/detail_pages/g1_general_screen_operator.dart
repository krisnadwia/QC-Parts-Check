...
class G1GeneralScreenOperator extends StatefulWidget {
  const G1GeneralScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _G1GeneralScreenOperatorState();
}

class _G1GeneralScreenOperatorState extends State<G1GeneralScreenOperator> {
  // Create a timestamp
  ...
  Future<void> _deleteData(String dataId) async {
    await _g1GeneralParts.doc(dataId).delete();
            ...
            builder: (context, snapshot) {
              ...
              return IconButton(
                ...
                onPressed: () {
                  ...
                  _keteranganNotifikasiController.text = "Data ditambahkan: G1 General Part";
                  _createOrUpdate();
                },
              );
            },
