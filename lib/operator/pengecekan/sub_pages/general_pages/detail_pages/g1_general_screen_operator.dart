...
class _G1GeneralScreenOperatorState extends State<G1GeneralScreenOperator> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getDataFromFirestore() {
    return FirebaseFirestore.instance.collection('g1_general_parts').orderBy("tanggalPengecekan", descending: true).snapshots();
  }
  ...
  Future<void> _deleteProduct(String productId) async {
    await _g1GeneralParts.doc(productId).delete();
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final anchor = html.document.createElement("a") as html.AnchorElement..href = url..style.display = "none"..download = "G1_General_Parts_$formattedDate.csv";
    ...
    final File file = await (File(
        "${generalDownloadDir.path}/G1_General_Parts_$formattedDate.csv"
    ).create());
