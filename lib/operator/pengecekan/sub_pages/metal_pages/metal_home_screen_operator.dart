...
import 'package:qc_parts_check/operator/pengecekan/sub_pages/metal_pages/detail_pages/g1_metal_screen_operator.dart';
import 'package:qc_parts_check/operator/pengecekan/sub_pages/metal_pages/detail_pages/raya_metal_screen_operator.dart';

class MetalHomeScreenOperator extends StatefulWidget {
  const MetalHomeScreenOperator({super.key});
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            FutureBuilder<QuerySnapshot>(
                                              future: FirebaseFirestore.instance.collection("g1_metal_parts").get(), // Fetch the documents in the collection
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            FutureBuilder<QuerySnapshot>(
                                              future: FirebaseFirestore.instance.collection("raya_metal_parts").get(), // Fetch the documents in the collection
                                              builder: (context, snapshot) {
                                                if (snapshot.connectionState == ConnectionState.waiting) {
                                                  return const CircularProgressIndicator(); // Display a loading indicator while fetching data
                                                }
