...
class G1MetalScreenOperator extends StatefulWidget {
  const G1MetalScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _G1MetalScreenOperatorState();
}

class _G1MetalScreenOperatorState extends State<G1MetalScreenOperator> {
  var itemsNamaPart = [
    "Assy Front Wheel",
    "Assy Rear Wheel",
    "Bottom Ball Cover",
    "Bottom Cone",
    "Bracket Electric Motor LH",
    "Bracket Electric Motor RH",
    "Bracket Front License",
    "Bracket License Support",
    "Bracket Support Front License",
    "Cap Steering Stem",
    "Double Stand",
    "Footrest L",
    "Footrest R",
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getDataFromFirestore() {
    return FirebaseFirestore.instance.collection('g1_metal_parts').orderBy("tanggalPengecekan", descending: true).snapshots();
  }
  ...
  Future<void> _deleteProduct(String productId) async {
    await _g1MetalParts.doc(productId).delete();
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final anchor = html.document.createElement("a") as html.AnchorElement..href = url..style.display = "none"..download = "G1_Metal_Parts_$formattedDate.csv";
    ...
    final File file = await (File(
        "${generalDownloadDir.path}/G1_Metal_Parts_$formattedDate.csv"
    ).create());
