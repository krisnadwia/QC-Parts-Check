...
class RayaMetalScreenOperator extends StatefulWidget {
  const RayaMetalScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _RayaMetalScreenOperatorState();
}
...
class _RayaMetalScreenOperatorState extends State<RayaMetalScreenOperator> {
  ...
  Future<void> _deleteData(String dataId) async {
    await _rayaMetalParts.doc(dataId).delete();
