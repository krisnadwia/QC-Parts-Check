...
class _RayaSupplierScreenOperatorState
    extends State<RayaSupplierScreenOperator> {
  ...
  final CollectionReference _rayaSupplier =
      FirebaseFirestore.instance.collection("raya_supplier");
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _rayaSupplier.orderBy("namaPart", descending: false).snapshots(),
