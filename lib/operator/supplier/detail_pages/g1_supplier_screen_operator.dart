...
class G1SupplierScreenOperator extends StatefulWidget {
  const G1SupplierScreenOperator({super.key});

  @override
  State<StatefulWidget> createState() => _G1SupplierScreenOperatorState();
}
