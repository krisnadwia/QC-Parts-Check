...
import 'package:qc_parts_check/detail_pages/g1_electric_screen.dart';
import 'package:qc_parts_check/detail_pages/raya_electric_screen.dart';

class ElectricHomeScreen extends StatefulWidget {
  const ElectricHomeScreen({super.key});

  @override
  State<StatefulWidget> createState() => _ElectricHomeScreenState();
}

class _ElectricHomeScreenState extends State<ElectricHomeScreen> with TickerProviderStateMixin {
  // Animation function
