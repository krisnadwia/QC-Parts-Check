...
import 'package:qc_parts_check/detail_pages/g1_general_screen.dart';
import 'package:qc_parts_check/detail_pages/raya_general_screen.dart';

class GeneralHomeScreen extends StatefulWidget {
  const GeneralHomeScreen({super.key});

  @override
  State<StatefulWidget> createState() => _GeneralHomeScreenState();
}

class _GeneralHomeScreenState extends State<GeneralHomeScreen> with TickerProviderStateMixin {
  // Animation function
