...
class _HomeScreenGraphState extends State<HomeScreenGraph> with TickerProviderStateMixin {
  // Animation function
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const G1GraphHomeScreen(),
                                      ),
                                    );
                                  },
                                  child: Padding(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const RayaGraphHomeScreen(),
                                      ),
                                    );
                                  },
                                  child: Padding(
