...
class G1SupplierScreen extends StatefulWidget {
  const G1SupplierScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1SupplierScreenState();
}

class _G1SupplierScreenState extends State<G1SupplierScreen> {
