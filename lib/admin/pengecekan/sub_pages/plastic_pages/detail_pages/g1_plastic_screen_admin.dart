...
class G1PlasticScreenAdmin extends StatefulWidget {
  const G1PlasticScreenAdmin({super.key});

  @override
  State<StatefulWidget> createState() => _G1PlasticScreenAdminState();
}

class _G1PlasticScreenAdminState extends State<G1PlasticScreenAdmin> {
  // Create a timestamp
