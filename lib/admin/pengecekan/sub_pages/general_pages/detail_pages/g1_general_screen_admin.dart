...
class G1GeneralScreenAdmin extends StatefulWidget {
  const G1GeneralScreenAdmin({super.key});

  @override
  State<StatefulWidget> createState() => _G1GeneralScreenAdminState();
}

class _G1GeneralScreenAdminState extends State<G1GeneralScreenAdmin> {
  // Create a timestamp
