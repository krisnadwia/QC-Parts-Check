...
class G1MetalScreenAdmin extends StatefulWidget {
  const G1MetalScreenAdmin({super.key});

  @override
  State<StatefulWidget> createState() => _G1MetalScreenAdminState();
}

class _G1MetalScreenAdminState extends State<G1MetalScreenAdmin> {
  // Create a timestamp
