...
class RayaElectricScreenAdmin extends StatefulWidget {
  const RayaElectricScreenAdmin({super.key});

  @override
  State<StatefulWidget> createState() => _RayaElectricScreenAdminState();
}

class _RayaElectricScreenAdminState extends State<RayaElectricScreenAdmin> {
  // Create a timestamp
