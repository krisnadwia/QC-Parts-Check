...
class G1ElectricScreenAdmin extends StatefulWidget {
  const G1ElectricScreenAdmin({super.key});

  @override
  State<StatefulWidget> createState() => _G1ElectricScreenAdminState();
}

class _G1ElectricScreenAdminState extends State<G1ElectricScreenAdmin> {
  // Create a timestamp
