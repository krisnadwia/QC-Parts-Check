...
import 'package:qc_parts_check/graph_pages/g1_electric_graph_screen.dart';
...
class G1ElectricScreen extends StatefulWidget {
  const G1ElectricScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1ElectricScreenState();
}

class _G1ElectricScreenState extends State<G1ElectricScreen> {
  var itemsNamaPart = [
    "",
    "Battery",
    "Belt",
    ...
    "Display",
    "Electric Motor",
    "Electric Motor NICE 1.5KW",
    "Electric Motor NICE 2.0KW",
    "Flasher",
  ...
  Future<void> _deleteProduct(String productId) async {
    await _g1ElectricParts.doc(productId).delete();
