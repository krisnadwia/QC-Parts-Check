...
import 'package:qc_parts_check/graph_pages/raya_metal_graph_screen.dart';
...
class RayaMetalScreen extends StatefulWidget {
  const RayaMetalScreen({super.key});

  @override
  State<StatefulWidget> createState() => _RayaMetalScreenState();
}

class _RayaMetalScreenState extends State<RayaMetalScreen> {
  var itemsNamaPart = [
    "",
    "Assy Front Wheel",
    "Assy Rear Wheel",
  ...
  Future<void> _deleteProduct(String productId) async {
    await _rayaMetalParts.doc(productId).delete();
