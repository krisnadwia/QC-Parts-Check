...
import 'package:qc_parts_check/graph_pages/g1_plastic_graph_screen.dart';
...
class G1PlasticScreen extends StatefulWidget {
  const G1PlasticScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1PlasticScreenState();
}

class _G1PlasticScreenState extends State<G1PlasticScreen> {
  var itemsNamaPart = [
    "",
    "Backshield",
    "Battery Partition",
