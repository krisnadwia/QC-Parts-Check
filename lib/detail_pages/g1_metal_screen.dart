...
import 'package:qc_parts_check/graph_pages/g1_metal_graph_screen.dart';
import 'package:qc_parts_check/support_pages/g1_supplier_screen.dart';
...
class G1MetalScreen extends StatefulWidget {
  const G1MetalScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1MetalScreenState();
}

class _G1MetalScreenState extends State<G1MetalScreen> {
  var itemsNamaPart = [
    "",
    "Assy Front Wheel",
    "Assy Rear Wheel",
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => const G1SupplierScreen(),
                ),
              );
            },
          ),
