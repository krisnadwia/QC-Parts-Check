...
import 'package:qc_parts_check/graph_pages/g1_general_graph_screen.dart';
...
class G1GeneralScreen extends StatefulWidget {
  const G1GeneralScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1GeneralScreenState();
}

class _G1GeneralScreenState extends State<G1GeneralScreen> {
  var itemsNamaPart = [
    "",
    "Bearing Front Wheel",
    "Bearing Rear Wheel",
