...
import 'package:qc_parts_check/graph_pages/raya_plastic_graph_screen.dart';
...
class RayaPlasticScreen extends StatefulWidget {
  const RayaPlasticScreen({super.key});

  @override
  State<StatefulWidget> createState() => _RayaPlasticScreenState();
}

class _RayaPlasticScreenState extends State<RayaPlasticScreen> {
  var itemsNamaPart = [
    "",
    "Backshield",
    "Battery Partition",
