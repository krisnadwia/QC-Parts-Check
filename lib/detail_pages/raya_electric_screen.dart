...
import 'package:qc_parts_check/graph_pages/raya_electric_graph_screen.dart';
...
class RayaElectricScreen extends StatefulWidget {
  const RayaElectricScreen({super.key});

  @override
  State<StatefulWidget> createState() => _RayaElectricScreenState();
}

class _RayaElectricScreenState extends State<RayaElectricScreen> {
  var itemsNamaPart = [
    "",
    "Battery",
    "Belt",
