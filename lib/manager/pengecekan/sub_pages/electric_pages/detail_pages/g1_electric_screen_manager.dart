...
class G1ElectricScreenManager extends StatefulWidget {
  const G1ElectricScreenManager({super.key});

  @override
  State<StatefulWidget> createState() => _G1ElectricScreenManagerState();
}

class _G1ElectricScreenManagerState extends State<G1ElectricScreenManager> {
  // Create a timestamp
