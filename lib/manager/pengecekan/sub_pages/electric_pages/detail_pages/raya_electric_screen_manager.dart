...
class RayaElectricScreenManager extends StatefulWidget {
  const RayaElectricScreenManager({super.key});

  @override
  State<StatefulWidget> createState() => _RayaElectricScreenManagerState();
}
...
class _RayaElectricScreenManagerState extends State<RayaElectricScreenManager> {
  ...
  Future<DocumentSnapshot> fetchDataById(String documentId) async {
    DocumentSnapshot documentSnapshot =
        await FirebaseFirestore.instance.collection('raya_electric_parts').doc(documentId).get();
                                      ...
                                      actions: [
                                        ElevatedButton(
                                          onPressed: () async {
                                            ...
                                            await _rayaElectricParts.doc(documentSnapshot.id).set({
                                              "namaPart": namaPart,
    ...
    return Scaffold(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  ...
                                  content: Text(
                                    "GESITS Raya Electric Parts was exported to Download folder!",
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _rayaElectricParts.orderBy("tanggalPengecekan", descending: true).snapshots(),
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final File file = await (File("${generalDownloadDir.path}/Raya_Electric_Parts_$formattedDate.csv").create());
