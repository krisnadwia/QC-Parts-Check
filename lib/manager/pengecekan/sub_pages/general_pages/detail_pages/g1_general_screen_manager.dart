...
class G1GeneralScreenManager extends StatefulWidget {
  const G1GeneralScreenManager({super.key});

  @override
  State<StatefulWidget> createState() => _G1GeneralScreenManagerState();
}

class _G1GeneralScreenManagerState extends State<G1GeneralScreenManager> {
  // Create a timestamp
  ...
  Future<DocumentSnapshot> fetchDataById(String documentId) async {
    DocumentSnapshot documentSnapshot =
        await FirebaseFirestore.instance.collection('g1_general_parts').doc(documentId).get();
  ...
  final CollectionReference _g1GeneralParts = FirebaseFirestore.instance.collection("g1_general_parts");
  List<DocumentSnapshot> documents = [];

  Stream<QuerySnapshot<Map<String, dynamic>>> getDataFromFirestore() {
    return FirebaseFirestore.instance
        .collection('g1_general_parts')
                    ...
                    StreamBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return OutlinedButton.icon(
                                ...
                                : showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                      ...
                                      actions: [
                                        ElevatedButton(
                                          onPressed: () async {
                                            _divalidasiOlehController.text = document?["name"];
                                            _statusValidasiController.text = "Sudah Divalidasi";
                                            ...
                                            await _g1GeneralParts.doc(documentSnapshot.id).set({
                                              "namaPart": namaPart,
                          ...
                          icon: Icon(
                            documentSnapshot["statusValidasi"] == "Sudah Divalidasi" ? Icons.check : Icons.check_box,
                          ),
                          label: Text(
                            documentSnapshot["statusValidasi"] == "Sudah Divalidasi" ? "Selesai" : "Validasi",
                            style: TextStyle(
                              color:
                                  documentSnapshot["statusValidasi"] == "Sudah Divalidasi" ? Colors.green : Colors.red,
                            ),
                          ),
                        );
                      },
    ...
    return Scaffold(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  ...
                                  content: Text(
                                    "GESITS G1 General Parts was exported to Download folder!",
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _g1GeneralParts.orderBy("tanggalPengecekan", descending: true).snapshots(),
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Icon(
                                                      ...
                                                      color: documentSnapshot["statusValidasi"] == "Belum Divalidasi"
                                                          ? Colors.red
                                                          : Colors.green,
                                                    ),
                                                    const SizedBox(
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final anchor = html.document.createElement("a") as html.AnchorElement
      ..href = url
      ..style.display = "none"
      ..download = "G1_General_Parts_$formattedDate.csv";
    html.document.body!.children.add(anchor);
    anchor.click();
    html.Url.revokeObjectUrl(url);
  } else if (Platform.isAndroid) {
    Directory generalDownloadDir = Directory("storage/emulated/0/Download");
    final File file = await (File("${generalDownloadDir.path}/G1_General_Parts_$formattedDate.csv").create());
