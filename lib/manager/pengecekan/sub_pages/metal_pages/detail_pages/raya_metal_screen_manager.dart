...
class RayaMetalScreenManager extends StatefulWidget {
  const RayaMetalScreenManager({super.key});

  @override
  State<StatefulWidget> createState() => _RayaMetalScreenManagerState();
}

class _RayaMetalScreenManagerState extends State<RayaMetalScreenManager> {
  // Create a timestamp
  ...
  Future<DocumentSnapshot> fetchDataById(String documentId) async {
    DocumentSnapshot documentSnapshot =
        await FirebaseFirestore.instance.collection('raya_metal_parts').doc(documentId).get();
                                      ...
                                      actions: [
                                        ElevatedButton(
                                          onPressed: () async {
                                            ...
                                            await _rayaMetalParts.doc(documentSnapshot.id).set({
                                              "namaPart": namaPart,
    ...
    return Scaffold(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  ...
                                  content: Text(
                                    "GESITS Raya Metal Parts was exported to Download folder!",
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _rayaMetalParts.orderBy("tanggalPengecekan", descending: true).snapshots(),
...
generateCsv() async {
  ...
  if (kIsWeb) {
    ...
    final File file = await (File("${generalDownloadDir.path}/Raya_Metal_Parts_$formattedDate.csv").create());
