...
import 'package:qc_parts_check/manager/supplier/detail_pages/g1_supplier_screen_manager.dart';
import 'package:qc_parts_check/manager/supplier/detail_pages/raya_supplier_screen_manager.dart';

class HomeScreenSupplierManager extends StatefulWidget {
  const HomeScreenSupplierManager({super.key});

  @override
  State<StatefulWidget> createState() => _HomeScreenSupplierManagerState();
}

class _HomeScreenSupplierManagerState extends State<HomeScreenSupplierManager> with TickerProviderStateMixin {
  // Animation function
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const G1SupplierScreenManager(),
                                      ),
                                    );
                                  },
                                  child: Padding(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const RayaSupplierScreenManager(),
                                      ),
                                    );
                                  },
                                  child: Padding(
