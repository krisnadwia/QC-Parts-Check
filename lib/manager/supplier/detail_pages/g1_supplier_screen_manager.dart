...
class G1SupplierScreenManager extends StatefulWidget {
  const G1SupplierScreenManager({super.key});

  @override
  State<StatefulWidget> createState() => _G1SupplierScreenManagerState();
}
