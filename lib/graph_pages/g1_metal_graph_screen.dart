...
class G1MetalGraphScreen extends StatefulWidget {
  const G1MetalGraphScreen({super.key});

  @override
  State<StatefulWidget> createState() => _G1MetalGraphScreenState();
}

class _G1MetalGraphScreenState extends State<G1MetalGraphScreen> {
